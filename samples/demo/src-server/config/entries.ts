...
export const entries: EntryInfo[] = [
    ...
    { name: 'lookup-lsc-04-http-download-blob', import: '@told/stack/src/data-patterns/lookup-lsc/src-server/function-04-http-download-blob', configImport: './config-lookup-lsc' },
